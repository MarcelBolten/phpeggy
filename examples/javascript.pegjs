/*
 * ! This is php-compatible version of grammar "pegjs/examples/javascript.pegjs"
 *
...
HexIntegerLiteral
  = "0" [xX] digits:$HexDigit+ { return intval($digits, 16); }
...
DoubleStringCharacters
  = chars:DoubleStringCharacter+ { return join("", $chars); }
...
RegularExpressionFlags
  = parts:IdentifierPart* { return join("", $parts); }
  ...
  = head:(
    ...
    tail:(
      ...
      for ($i = 0; $i < count($tail); $i++) {
        $result = array_merge($result, (array)$tail[$i]);
      }
      return $result;
    }
