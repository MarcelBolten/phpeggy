...
class Parser
{
     ...
     * @return mixed
     */
    private function peg_f2($customText, $noTeaser)
    {
     ...
     * @return mixed
     */
    private function peg_f3($blockName, $a)
    {
        return $a;
    }
