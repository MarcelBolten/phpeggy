...
class php52_compat_Parser {
    ...
    private function peg_parseLetter_Or_Number() {
      ...
      $s0 = $this->peg_currPos;
      if (php52_compat_peg_regex_test($this->peg_c0, $this->input_substr($this->peg_currPos, 1))) {
    ...
    private function peg_parseChar_Padding_Test() {
      ...
      $s0 = $this->peg_currPos;
      if (php52_compat_peg_regex_test($this->peg_c4, $this->input_substr($this->peg_currPos, 1))) {
        $s1 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s1 = $this->peg_FAILED;
    ...
    private function peg_parsePile_Of_Poo() {
      ...
      if ($s1 !== $this->peg_FAILED) {
        if (php52_compat_peg_regex_test($this->peg_c10, $this->input_substr($this->peg_currPos, 1))) {
    ...
    private function peg_parseWhitespace() {
      ...
      $s0 = $this->peg_currPos;
      $s1 = array();
      if (php52_compat_peg_regex_test($this->peg_c12, $this->input_substr($this->peg_currPos, 1))) {
        $s2 = $this->input_substr($this->peg_currPos, 1);
        $this->peg_currPos++;
      } else {
        $s2 = $this->peg_FAILED;
