<?php
/**
 * Generated by Peggy 4.2.0 with PHPeggy plugin 2.1.0
 *
 * https://peggyjs.org/
...
class Parser
{
    ...
    private string $peg_c0 = "/^[-0-9A-Z_a-z]/";
    private string $peg_c1 = "/^[a-zA-Z]/";
    private string $peg_c2 = "/^[0-9]/";
    private string $peg_c3 = "/^[-_]/";
    ...
    public function __construct()
    {
        ...
        $this->peg_e11 = new pegExpectation("class", "[0-9]", "[0-9]", "false");
        $this->peg_e12 = new pegExpectation("class", "[-_]", "[-_]", "false");
    ...
    private function peg_parse_WP_Block_List(): mixed
    {
        $s0 = [];
    ...
    private function peg_parse_WP_Block(): mixed
    {
    ...
    private function peg_parse_WP_Block_Void(): mixed
    {
        $s0 = $this->peg_currPos;
    ...
    private function peg_parse_WP_Block_Balanced(): mixed
    {
        $s0 = $this->peg_currPos;
    ...
    private function peg_parse_WP_Block_Start(): mixed
    {
        $s0 = $this->peg_currPos;
        if ($this->input_substr($this->peg_currPos, 4) === $this->peg_l0) {
            $s1 = $this->peg_l0;
    ...
    private function peg_parse_WP_Block_End(): mixed
    {
        $s0 = $this->peg_currPos;
        if ($this->input_substr($this->peg_currPos, 4) === $this->peg_l0) {
            $s1 = $this->peg_l0;
    ...
    private function peg_parse_WP_Block_Name(): mixed
    {
        $s0 = $this->peg_currPos;
        $s1 = $this->peg_currPos;
    ...
    private function peg_parse_WP_Block_Attributes(): mixed
    {
        $s0 = $this->peg_currPos;
        $s1 = $this->peg_currPos;
        $s2 = $this->peg_currPos;
    ...
    private function peg_parse___(): mixed
    {
        $s0 = [];
        $s1 = $this->peg_parse__();
        if ($s1 !== $this->peg_FAILED) {
    ...
    private function peg_parse_Any(): mixed
    {
        if ($this->input_length > $this->peg_currPos) {
            $s0 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
