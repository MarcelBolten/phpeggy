<?php
/*
 * Generated by Peggy 1.0.0 with PHPeggy plugin 1.0.0-rc.1
 *
 * https://peggyjs.org/
 */
...
class Parser
{
    ...
    {
        $s0 = $this->peg_currPos;
        if (peg_char_class_test($this->peg_c8, $this->input_substr($this->peg_currPos, 1))) {
            $s1 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
        } else {
            $s1 = $this->peg_FAILED;
        ...
        if ($s1 !== $this->peg_FAILED) {
            if (peg_char_class_test($this->peg_c10, $this->input_substr($this->peg_currPos, 1))) {
    ...
    private function peg_parseWhitespace()
    {
        $s0 = $this->peg_currPos;
        $s1 = array();
        if (peg_char_class_test($this->peg_c12, $this->input_substr($this->peg_currPos, 1))) {
            $s2 = $this->input_substr($this->peg_currPos, 1);
            $this->peg_currPos++;
        } else {
            $s2 = $this->peg_FAILED;
